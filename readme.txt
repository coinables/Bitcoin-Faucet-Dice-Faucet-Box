...
Includes a faucet referral system built-in and AreYouAHuman for anti-bot. Just need to update the API keys in the 
two index.php files and your AreYouAHuman keys in the ayah_config. 

This script uses PHP, faucetbox API, and AreYouAHuman for anti-bot protection. 

You will need to sign up with FaucetBox and AreYouAHuman.com to obtain API Keys. 
...
3. Open up the index.php file in BOTH directories (facuetbox and faucetboxgame). 
   ...
   *** Updated your API keys with AreYouAHuman in the ayah_config.php
